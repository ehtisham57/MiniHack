    ...
    <div className="max-w-screen-2xl px-24  py-5 mx-auto">
      <div className="flex min-h-full flex-1 flex-col justify-center px-24  py-5 lg:px-8">
        ...
        <form onSubmit={onSubmitHandler}>
          <div className="mb-6">
            <label for="default-input" className="block mb-2 text-sm font-medium text-black">Write Your Title</label>
            <textarea
          ...
          <div className="mb-6">
            <label for="large-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Type Your Detail Description For Blog</label>
            <textarea
